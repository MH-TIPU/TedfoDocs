                ...
                <div class="col-lg-3 col-sm-6 col-md-6 col-xs-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="progress">
                                <div class="progress-bar l-green" role="progressbar" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" style="width: {{100/ Auth::user()->Seller()->count() }}%;"></div>
                            </div>
                            <span class="text-small">{{100 / Auth::user()->Seller()->count() }}% more than last month</span> </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-md-6 col-xs-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="progress">
                                <div class="progress-bar l-blush" role="progressbar" aria-valuenow="{{Auth::user()->Buyer()->count() }}" aria-valuemin="0" aria-valuemax="100" style="width: {{100 / Auth::user()->Buyer()->count() }}%;"></div>
                            </div>
                            <span class="text-small">{{100 / Auth::user()->Buyer()->count() }}% more than last month</span> </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-md-6 col-xs-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="progress">
                                <div class="progress-bar l-amber" role="progressbar" aria-valuenow="{{Auth::user()->Product()->count() }}" aria-valuemin="0" aria-valuemax="{{100 / Auth::user()->Product()->count()}}" style="width: {{100 / Auth::user()->Product()->count()}}%;"></div>
                            </div>
                            <span class="text-small">{{100 / Auth::user()->Product()->count() }}% more than last month</span> </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 col-md-6 col-xs-12">
                    <div class="card">
